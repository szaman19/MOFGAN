...
class Rotations:
    ...
    @staticmethod
    def rotate_2d(tensor: Tensor, exclude_original=False):
        ...
        if exclude_original:
            ...
            return tensor, rotate_90, rotate_180, rotate_270

    @staticmethod
    def rotate_3d(tensor: Tensor, exclude_original=False):
        ...
        if exclude_original:
            return x90, x180, x270, y90, y180, y270, z90, z180, z270  # 9
        else:
            # return tensor, x90, x180, x270, tensor, y90, y180, y270, tensor, z90, z180, z270, tensor
            return tensor, x90, x180, x270, y90, y180, y270, z90, z180, z270  # 10
