...
from src.grid_generator import Generate_Supercell_coords, GridGenerator
...
def main():
  ...
  super_cell_coords = Generate_Supercell_coords(unit_cell_coords)
  ...
  grid = GridGenerator(torch_coords, a , b, c, alpha, beta, gamma)
